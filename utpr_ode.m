...
% lg_1 =  0.17; % Center of gravity of the arm
...
% 
% 
% m1  = 1.258;    % Mass of the arm
% %m_h  = 130e-3;    % Mass of the encoder
% m2  = 5.686;  % Mass of the pendulum
% %m2  = 1.086;  % Mass of the pendulum
% m3  = 2.162;  % Mass of the pendulum
% 
% J1 = 0.0121;
% J2 = 0.0398;
% J3 = 0.0487;
