function [A, B, M] = utpr(x, T)
% utpr_lpv Calculates the LPV model matrices of the UTPR
%   This function calculates the model matrices of the LPV model of the UTPR, given the current
%   state of the system.
%
%   Arguments:
